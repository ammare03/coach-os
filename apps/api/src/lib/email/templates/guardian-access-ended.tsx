...
export function GuardianAccessEndedEmail({ recipient }: GuardianAccessEndedEmailProps) {
      ...
      <EmailLayout
        ...
        body={
          <Text style={{ fontSize: '14px', lineHeight: '20px', margin: 0 }}>
            The CoachOS account you had guardian access to now belongs to someone who has turned 18.
            Guardian access — consent management, exports, and deletion requests on their behalf —
            has ended. No further action is needed from you.
          </Text>
        }
      />
    );
  ...
  return (
    <EmailLayout
      ...
      body={
        <Text style={{ fontSize: '14px', lineHeight: '20px', margin: 0 }}>
          Now that you&apos;re 18, your CoachOS account no longer needs guardian consent to operate,
          and features that were unavailable to a minor account are now available. Your coach and
          your data are unchanged.
        </Text>
      }
    />
  );
