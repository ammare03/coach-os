  ...
  return createElement(EmailLayout, {
    ...
    body: createElement(
      ...
      createElement(
        ...
        `${clientName} has been invited to join CoachOS as a client of ${coachName}. Because they're under 18, we need a parent or guardian to confirm before their account can start.`,
      ),
      createElement(
        Text,
        { style: { fontSize: '14px', lineHeight: '20px', margin: 0 } },
        'Nothing happens with their account until you confirm — no coaching, no data collection beyond this request.',
      ),
    ),
  });
}
